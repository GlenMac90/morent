  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        day_selected:
          "bg-blue500 text-slate-50 hover:bg-slate-900 hover:text-slate-50 focus:bg-blue500 focus:text-slate-50 dark:bg-blue500 dark:text-slate-900 dark:hover:bg-slate-50 dark:hover:text-slate-900 dark:focus:bg-blue500 dark:focus:text-slate-900",
        day_today:
